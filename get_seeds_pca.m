...
%%
function [ seed, data1, data2 ] = get_seeds_pca( imacov_vec )

%% Compute parameters -------------------------------------------------
m = [mean(sqrt(imacov_vec(:, 1))) mean(sqrt(imacov_vec(:, 5))) mean(sqrt(imacov_vec(:, 9)))]; 
Sigma = average_covariance(imacov_vec);
